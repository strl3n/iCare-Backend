...
// ==================== ROUTES ====================
// Perbaikan: Tambahkan folder src/ di path
  ...
  try {
    ...
    if (!process.env.RAPIDAPI_KEY) {
      ...
      return res.json({
        ...
        data: {
          quote:
            "Kesehatan mental bukanlah tujuan, tapi proses. Mari jaga kesehatan mental kita bersama.",
          author: "iCare",
        },
      });
    }
    ...
    const fallbackQuotes = [
      ...
      {
        quote:
          "Setiap hari adalah kesempatan baru untuk menjadi lebih baik. Kamu berharga!",
        author: "iCare",
      },
      {
        quote: "Kamu lebih kuat dari yang kamu kira. Jangan pernah menyerah.",
        author: "iCare",
      },
      {
        quote: "Kebahagiaan sejati dimulai dari kesehatan mental yang baik.",
        author: "iCare",
      },
      {
...
app.get("/api/quote/id", async (req, res) => {
  try {
    const quotesIndonesia = [
      {
        quote: "Kebahagiaan bukanlah tujuan akhir, melainkan perjalanan hidup.",
        author: "iCare",
      },
      {
      ...
      {
        quote:
          "Jangan pernah menyerah, karena ada banyak orang yang peduli padamu.",
        author: "iCare",
      },
      {
        quote: "Kesehatan mental adalah kunci kebahagiaan sejati.",
        author: "iCare",
      },
      {
        quote: "Kamu berharga dan berarti. Jangan pernah lupa itu.",
      ...
      {
        quote:
          "Kesedihan hari ini bukanlah akhir dari segalanya. Besok akan lebih baik.",
        author: "iCare",
      },
      {
        quote: "Meminta bantuan adalah tanda kekuatan, bukan kelemahan.",
        author: "iCare",
      },
      {
        quote:
          "Tidak ada yang salah dengan merasa sedih. Itu adalah bagian dari menjadi manusia.",
        author: "iCare",
      },
      {
        quote:
          "Kamu tidak sendiri. Ada banyak orang yang peduli dan siap membantu.",
        author: "iCare",
      },
    ];
...
app.get("/health", (req, res) => {
  res.json({
    ...
    endpoints: {
      auth: "/api/auth",
      mood: "/api/mood",
      quote: "/api/quote (RapidAPI - Quotes-API)",
